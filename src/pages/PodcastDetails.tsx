        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center">
            ...
            scale: 0.9
              ...
              <Link to="/" className="mr-4 p-3 md:p-4 bg-juricast-card hover:bg-juricast-accent hover:text-white rounded-full transition-all flex items-center justify-center" aria-label="Voltar">
            ...
            duration: 0.5
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {Array.isArray(episode.tag) && episode.tag.map((tag: string, index: number) => <motion.span key={index} className="bg-juricast-background/50 px-2 py-1 rounded-full text-xs md:text-sm border border-juricast-card/30" initial={{
                  opacity: 0,
                  scale: 0.8
                }} animate={{
                  opacity: 1,
