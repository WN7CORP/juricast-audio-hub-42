...
import { Search, Home, Heart, Clock, List, Check, BookOpen, GraduationCap, LayoutGrid } from 'lucide-react';
      ...
      >
        {navItems.map((item) => {
          const isActive = path === item.href || 
            (item.href === "/categorias" && (path.includes("/categoria") || path.includes("/categorias")));
