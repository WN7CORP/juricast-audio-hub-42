...
const MainNavigation = ({
  ...
  return <div className="flex justify-center mb-3">
      <motion.div className="bg-juricast-card/40 backdrop-blur-md py-2 px-4 rounded-2xl shadow-lg border border-juricast-card/30 flex justify-around items-center gap-1" initial={{
      y: -20,
      opacity: 0
    }} animate={{
      y: 0,
